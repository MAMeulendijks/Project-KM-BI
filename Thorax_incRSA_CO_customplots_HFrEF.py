# -*- coding: utf-8 -*-
"""
Created on Thu Oct 17 10:33:24 2024
...
from Calculate_EF import calculate_ejection_fraction
...
HFrEF = 'on'    # on, off, or inversed

if HFrEF == 'on':
    sfact_lv = model['Patch']['Sf_act']['pLv0']
    sfact_sv = model['Patch']['Sf_act']['pSv0']
    
    model['Patch']['Sf_act']['pLv0'] = 0.45*sfact_lv
    model['Patch']['Sf_act']['pSv0'] = 0.45*sfact_sv
...
EFs = calculate_ejection_fraction(flow_aortic_valve, time_points, cycle_times, n_beats, V_lv)
...
print('No breathing EFs are ', EFs)
